    ...
    for list_group in list_groups:
        ...
        for item in list_items:
            try:
                ...
                ##todo:fix the bug about encoding
                traceback.print_exc()
            num = num + 1
...
def get_api_qualifier_name_from_api_document_link(api_document_link):
    if "https://developer.android.com/reference/" in api_document_link:
        api_document_link = api_document_link.replace("https://developer.android.com/reference/", "")
    if "https://developer.android.google.cn/reference/" in api_document_link:
        api_document_link = api_document_link.replace("https://developer.android.google.cn/reference/", "")
